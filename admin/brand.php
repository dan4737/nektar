  ...
  <div class="content-wrapper px-3">
    ...
    <section class="content">
              ...
              <div class="modal-body">
                <form id="form">
                  <div class="form-group">
                      <input class="form-control" type="text" placeholder="Brand Name" name="type" id="type" required>
                  </div>

                  <div class="form-submit">
                      <button type="button" class="btn bg-orange" name="addtype" onclick="insert()" id="addtype"> Add Brand </button>
                  </div>
                </form>
              </div>
              <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <a href="brand.php"> <button type="button" class="btn btn-success">Save changes</button></a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
      ...
      <!-- /.modal -->
        ...
        <div class="row">
          <div class="ml-2" >
            <button type='button' class='btn bg-orange ml-0 mb-2' data-toggle="modal" data-target="#modal-default">Add A New Brand</button>
          </div>
          <div class="col-12">
                        ...
                        if(!empty($brands)){
                            foreach($brands as $x){
                                ...
                                <tr>
                                    <td>{$x['brand_id']}</td>
                                    <td>{$x['brand_name']}</td>
                                    <td><a href='updatebrandform.php?id={$x['brand_id']}'>Update</a></td>
                                    <td><a href='../functions/deletebrand.php?deletebrandID={$x['brand_id']}'>Delete</a></td>
                                </tr>
                                "; 
                            }
                        }
