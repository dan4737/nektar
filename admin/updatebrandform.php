...
<div class="wrapper">
 ...
 <!-- <div class="preloader flex-column justify-content-center align-items-center">
  ...
  <div class="content-wrapper px-3">
	...
	<div class="container">
        <form method="post" action="../functions/updatebrand.php" name="updatebrand">
          <div class="form-group">
            <label>Brand Name</label>
            <input type="text" class="form-control" id="name" name="brand_name"  value="<?php echo $brand['brand_name'] ?>">
          </div>

          <input type="hidden"  value="<?php echo $brand['brand_id'] ?>" name="brand_id">
         

          <button type="submit" class="btn btn-primary" name="updatebrand">Update Brand</button>
        </form>
	</div>
