...
<div class="wrapper">
 ...
 <!-- <div class="preloader flex-column justify-content-center align-items-center">
  ...
  <aside class="main-sidebar sidebar-dark-orange bg-black my-1 mx-1 mb-1 rounded elevation-4">
    <!-- Brand Logo -->
  ...
  <div class="content-wrapper px-3">
    ...
    <section class="content">
      <div class="container-fluid">
		...
		// orangeirect if user isn't admin
		// require_once('../settings/core.php');
		// if(check_login()){
		//	if($_SESSION['role']!=0){
    ...
    <div class="container">
        ...
        <form method="post" action="../functions/addproduct.php" enctype="multipart/form-data" >
          ...
          <div class="form-group">
            ...
            <input type="float" class="form-control" id="pprice" name="pprice">
          </div>
          <div class="form-group">
