          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer justify-content-between">
                ...
                <a href="categories.php"> <button type="button" class="btn btn-success">Save changes</button></a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <?php
                    ...
                    $category = displaycategories_controller();
                        if(!empty($category)){
                            foreach($category as $x){
                                ...
                                <tr>
                                    <td>{$x['cat_id']}</td>
                                    <td>{$x['cat_name']}</td>
                                    <td><a href='updatecategoryform.php?id={$x['cat_id']}'>Update</a></td>
