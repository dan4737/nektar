  ...
  <div class="content-wrapper px-3">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="ml-2" >
            <a href='addproductform.php'><button type='button' class='btn bg-orange ml-0 mb-2' >Add A New Product</button></a>
          </div>
          <div class="col-12">
                        ...
                        if(!empty($products)){
                            foreach($products as $x){
                                ...
                                <tr>
                                    ...
                                    <td><a href='updateproductform.php?id={$x['product_id']}'>Update</a></td>
                                    <td><a href='../functions/deleteproduct.php?deleteproductID={$x['product_id']}'>Delete</a></td>
                                </tr>
                                "; 
                            }
                        }
